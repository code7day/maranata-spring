...
<div x-data="{
    ...
    <div class="relative w-full h-48 md:h-48 rounded-t-2xl bg-gradient-to-br from-blue-400 to-green-500 flex items-center justify-center text-white overflow-hidden">
